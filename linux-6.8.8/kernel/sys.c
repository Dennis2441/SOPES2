...
/// Definición de la syscall: capture_memory_snapshot  
SYSCALL_DEFINE0(capture_memory_snapshot) {  
    printk(KERN_INFO "Syscall: capture_memory_snapshot ejecutada\n");  
    return 0;  
}  

// Definición de la syscall: track_syscall_usage  
SYSCALL_DEFINE0(track_syscall_usage) {  
    printk(KERN_INFO "Syscall: track_syscall_usage ejecutada\n");  
    return 0;  
}  

// Definición de la syscall: get_io_throttle  
SYSCALL_DEFINE0(get_io_throttle) {  
    printk(KERN_INFO "Syscall: get_io_throttle ejecutada\n");  
    return 0;  
}  
/*
